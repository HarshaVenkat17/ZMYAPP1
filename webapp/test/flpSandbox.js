					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My Sample Shopfloor",
									"targetURL": "#myapp1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"myapp1-display": {
								"semanticObject": "myapp1",
								"action": "display",
								"description": "A sample shop floor app",
								"title": "My Sample Shopfloor",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=myapp1",
									"url": sap.ui.require.toUrl("myapp1")
								}
							}
						}
					}
